...
# baloise.dev/appdeployment-operator-bundle:$VERSION and baloise.dev/appdeployment-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= registry.baloise.dev/niiku/appdeployment-operator
